...
export default function Who() {
  ...
  <div className="bg-[#0a0a0a]">
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative max-w-6xl  text-brand mx-auto px-4 sm:px-6 lg:px-8 text-center">
        
       
        <span className="bg-brand2 px-5 py-2 rounded-3xl border border-1 border-brand mt-20  inline-flex items-center gap-2 mb-6">
           من نحن
        ...
        <div dir="rtl" className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          <div className=" bg-brand3 rounded-2xl border border-1 border-gray-800 p-6">
    ...
    <section className="py-20 bg-[#111111] border-y border-[#262626]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div dir="rtl" className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div
          ...
          >
            <div
              className="absolute inset-0 bg-gradient-to-br from-orange-500 to-yellow-500 opacity-0 group-hover:opacity-10 transition-opacity duration-300"
            >
            </div>
          ...
          >
            <div
              className="absolute inset-0 bg-gradient-to-br from-orange-600 to-orange-400 opacity-0 group-hover:opacity-10 transition-opacity duration-300"
            >
            </div>
            <div className="relative">
    ...
    <section className="py-20 bg-[#0a0a0a]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="bg-brand2 px-5 py-2 text-brand rounded-3xl border border-1 border-brand mt-20  inline-flex items-center gap-2 mb-6">
           فريقنا
          <span className="w-2 h-2 bg-orange-500 rounded-full animate-pulse">
        ...
        <div dir="rtl" className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div
...
>
  ...
  <section className="py-20 bg-gradient-to-br from-orange-600 via-orange-500 to-yellow-500 relative overflow-hidden">
    ...
    <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <div dir="rtl" className="flex flex-col sm:flex-row justify-center gap-4">
        <a

...
<div className="min-h-[calc(100vh-5rem)] pt-25 pb-10 flex items-center justify-center relative overflow-hidden bg-[#0a0a0a]">
  ...
  <div className="relative text-center px-4 max-w-lg mx-auto">
    ...
    <div dir="rtl" className="flex flex-col sm:flex-row justify-center gap-4 mb-12">

      
      <Link
        className=" bg-brand p-4 rounded-4xl text-2xl text-white inline-flex items-center justify-center gap-2"
        to="/"
      >
 ...
 الذهاب للرئيسية
      ...
      <Link
        className=" bg-transparent text-white border border-1 border-gray-800 rounded-4xl p-5 text-2xl inline-flex items-center justify-center gap-2 hover:text-brand hover:border-brand hover:bg-brand2 transition-all"
        to="/Blogs"
      >

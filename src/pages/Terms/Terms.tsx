...
export default function Terms() {
  return (
    <div dir="rtl"  className="bg-[#0a0a0a]  pt-20">
        ...
        <div className="space-y-12">
          ...
          <section >
            ...
            <div className="pr-11">
              ...
              <p className="text-neutral-400 leading-relaxed mb-4">
                ...
                عدسة لا يقدم أي ضمانات، صريحة أو ضمنية، ويخلي مسؤوليته
                من جميع الضمانات الأخرى.
              </p>
          ...
          <section >
            ...
            <div className="pr-11">
              ...
              <p className="text-neutral-400 leading-relaxed mb-4">
                في أي حال من الأحوال، لن يكون عدسة أو مورديه مسؤولين عن
                أي أضرار ناتجة عن استخدام أو عدم القدرة على استخدام المواد
                على الموقع.
              </p>
          ...
          <section >
            ...
            <div className="pr-11">
              ...
              <p className="text-neutral-400 leading-relaxed mb-4">
                ...
                ترخيصاً غير حصري وعالمي ومجاني لاستخدام هذا المحتوى
                وإعادة إنتاجه وتعديله وتوزيعه.
              </p>
          ...
          <section >
            ...
            <div className="pr-11">
              ...
              <p className="text-neutral-400 leading-relaxed mb-4">
                ...
                باستخدام هذا الموقع، فإنك توافق على الالتزام بالنسخة
                الحالية من شروط الخدمة.
              </p>
